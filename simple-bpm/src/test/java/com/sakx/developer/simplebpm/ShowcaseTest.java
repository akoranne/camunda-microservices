...
public class ShowcaseTest extends AbstractProcessEngineRuleTest {
	...
	public void startAndFinishProcess() throws Exception {
		showcase.run(new HashMap<String, Object>());
		...
		assertThat(historyService().createHistoricProcessInstanceQuery().processInstanceId(processInstanceId)
